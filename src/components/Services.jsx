...
import { service1, service2, service3, check,one, AhmedLogo, AhmedBackground, AhmedBackground2, two } from "../assets";
      ...
      <div className="mt-10 container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-auto xl:w-auto">
              <img
